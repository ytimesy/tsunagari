...
人物中心ですが、今後は「出会い」と「そこから起きた変化」を主役に寄せます。
...
- 公開人物録と出会いの背景情報を編集メンバーが蓄積できるようにする
- 次に活かせる学びやきっかけを残せるようにする
...
「誰と出会ったか」だけでなく、「その出会いで何がより良くなったか」を
伝えることを主目的にします。
